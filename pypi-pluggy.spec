...
Source0  : https://files.pythonhosted.org/packages/96/2d/02d4312c973c6050a18b314a5ad0b3210edb65a906f868e31c111dede4a6/pluggy-1.5.0.tar.gz
...
%prep
%setup -q -n pluggy-1.5.0
cd %{_builddir}/pluggy-1.5.0
pushd ..
cp -a pluggy-1.5.0 buildavx2
popd
pushd ..
cp -a pluggy-1.5.0 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713665993
